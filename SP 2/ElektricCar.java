public class ElektricCar extends ACar {
    ...
    public ElektricCar(String registrationNumber, String make, String model, int numberOfDoors, int batteryCapacity, int maxRange) {
    ...
    public String toString() {
        return "result: " +  getBatteryCapacityKWh() + getMaxRange();
